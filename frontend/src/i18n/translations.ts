...
export const vi = {
  ...
  menuGroupOps: 'Vận hành',
  menuGroupCatalog: 'Danh mục',
  menuGroupAdmin: 'Quản trị',
  ...
  importStep1Desc: 'File có 2 sheet: "Nhập dữ liệu" (nhập vào đây) và "Lựa chọn hợp lệ" (tham khảo giá trị).',
  importStep2: 'Bước 2: Tải file đã điền lên',
  importDragHint: 'Kéo file vào đây hoặc click để chọn',
  importDragAccept: 'Chấp nhận .xlsx, .xls, .csv — theo đúng format template',
  importPreview: 'Kiểm tra dữ liệu trước khi nhập',
  importPreviewDesc: 'Ô màu đỏ = thiếu dữ liệu bắt buộc. Dòng lỗi sẽ bị bỏ qua khi nhập.',
  importSuccess: 'Nhập thành công',
  importError: 'dòng có lỗi',
  importChooseAnother: 'Chọn file khác',
  importSubmit: 'Nhập vào hệ thống',
  importReadRowsPrefix: 'Đọc được',
  importReadRowsSuffix: 'dòng từ',
  importMoreRowsPrefix: '... và',
  importMoreRowsSuffix: 'dòng nữa',
  importResultDone: 'Hoàn tất',
  importResultSuccessLabel: 'thành công',
  importResultErrorLabel: 'lỗi',
  importFieldMissing: 'Thiếu',
  importTemplateDownloaded: 'Đã tải template xuống',
  importFileEmpty: 'File không có dữ liệu.',
  importNoValidData: 'Không tìm thấy dữ liệu hợp lệ. Kiểm tra lại file.',
  importFileReadError: 'Không đọc được file. Hãy dùng file .xlsx hoặc .csv từ template.',
  importGenericError: 'Có lỗi xảy ra khi nhập dữ liệu',
  importRecordsSuccessPrefix: 'Nhập thành công',
  importRecordsSuccessSuffix: 'bản ghi',
  importRowsErrorSuffix: 'dòng có lỗi',
...
export const en: Record<TranslationKey, string> = {
  ...
  menuGroupCatalog: 'Catalog',
  menuGroupAdmin: 'Administration',
  ...
  importStep1Desc: 'The file has 2 sheets: "Nhập dữ liệu" (enter data here) and "Lựa chọn hợp lệ" (valid value reference).',
  importStep2: 'Step 2: Upload completed file',
  importDragHint: 'Drag file here or click to browse',
  importDragAccept: 'Accepts .xlsx, .xls, .csv — must follow the template format',
  importPreview: 'Review data before importing',
  importPreviewDesc: 'Red cells = missing required data. Rows with errors will be skipped.',
  importSuccess: 'Successfully imported',
  importError: 'rows with errors',
  importChooseAnother: 'Choose another file',
  importSubmit: 'Import into system',
  importReadRowsPrefix: 'Read',
  importReadRowsSuffix: 'rows from',
  importMoreRowsPrefix: '... and',
  importMoreRowsSuffix: 'more rows',
  importResultDone: 'Done',
  importResultSuccessLabel: 'succeeded',
  importResultErrorLabel: 'errors',
  importFieldMissing: 'Missing',
  importTemplateDownloaded: 'Template downloaded',
  importFileEmpty: 'File has no data.',
  importNoValidData: 'No valid data found. Please check the file.',
  importFileReadError: 'Could not read the file. Use an .xlsx or .csv file from the template.',
  importGenericError: 'An error occurred while importing data',
  importRecordsSuccessPrefix: 'Successfully imported',
  importRecordsSuccessSuffix: 'records',
  importRowsErrorSuffix: 'rows with errors',
